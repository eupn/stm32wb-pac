...
impl W {
    ...
    #[doc = "Bit 20 - IPCC interface reset"]
    #[inline]
    pub fn ipccrst(&mut self) -> _IPCCRSTW {
        _IPCCRSTW { w: self }
    }
    #[doc = "Bit 19 - HSEM interface reset"]
    #[inline]
    pub fn hsemrst(&mut self) -> _HSEMRSTW {
        _HSEMRSTW { w: self }
    }
    #[doc = "Bit 18 - RNG interface reset"]
    #[inline]
    ...
    #[doc = "Bit 17 - AES2 interface reset"]
    #[inline]
    pub fn aes2rst(&mut self) -> _AES2RSTW {
        _AES2RSTW { w: self }
    }
    #[doc = "Bit 16 - PKA interface reset"]
    #[inline]
    pub fn pkarst(&mut self) -> _PKARSTW {
        _PKARSTW { w: self }
    }
    #[doc = "Bit 8 - Quad SPI memory interface reset"]
    #[inline]
