...
impl W {
    ...
    #[doc = "Bits 4:5 - Step Down converter clock prescaler"]
    #[inline]
    pub fn smpsdiv(&mut self) -> _SMPSDIVW {
        _SMPSDIVW { w: self }
    }
    #[doc = "Bits 0:1 - Step Down converter clock selection"]
    #[inline]
    pub fn smpssel(&mut self) -> _SMPSSELW {
        _SMPSSELW { w: self }
    }
}
