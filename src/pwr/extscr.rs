...
impl W {
    ...
    #[inline]
    pub fn ccrpf(&mut self) -> _CCRPFW {
        _CCRPFW { w: self }
    }
    #[doc = "Bit 1 - Clear CPU2 Stop Standby flags"]
    #[inline]
    pub fn c2cssf(&mut self) -> _C2CSSFW {
        _C2CSSFW { w: self }
    }
    #[doc = "Bit 0 - Clear CPU1 Stop Standby flags"]
    #[inline]
    pub fn c1cssf(&mut self) -> _C1CSSFW {
        _C1CSSFW { w: self }
    }
}
