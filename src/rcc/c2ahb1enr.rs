...
impl R {
    ...
    #[inline]
    pub fn dmamuxen(&self) -> DMAMUXENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 9 - CPU2 SRAM1 clock enable"]
    #[inline]
    pub fn sram1en(&mut self) -> _SRAM1ENW {
        _SRAM1ENW { w: self }
    }
    #[doc = "Bit 2 - CPU2 DMAMUX clock enable"]
    #[inline]
    pub fn dmamuxen(&mut self) -> _DMAMUXENW {
        _DMAMUXENW { w: self }
    }
    #[doc = "Bit 1 - CPU2 DMA2 clock enable"]
    #[inline]
