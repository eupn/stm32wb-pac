...
#[doc = r" Proxy"]
pub struct _EBORHSDFBW<'a> {
    w: &'a mut W,
}
impl<'a> _EBORHSDFBW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn eborhsdfb(&self) -> EBORHSDFBR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 14 - Enable CPU2 Hold interrupt for CPU1"]
    #[inline]
    pub fn ec2h(&mut self) -> _EC2HW {
        _EC2HW { w: self }
    }
    #[doc = "Bit 13 - Enable end of activity interrupt for CPU1"]
    #[inline]
    pub fn e802a(&mut self) -> _E802AW {
        _E802AW { w: self }
    }
    #[doc = "Bit 11 - Enable BLE end of activity interrupt for CPU1"]
    #[inline]
    pub fn eblea(&mut self) -> _EBLEAW {
        _EBLEAW { w: self }
    }
    #[doc = "Bit 12 - Enable critical radio phase end of activity interrupt for CPU1"]
    #[inline]
    pub fn ecrpe(&mut self) -> _ECRPEW {
        _ECRPEW { w: self }
    }
    #[doc = "Bit 10 - Apply pull-up and pull-down configuration"]
    #[inline]
    ...
    #[doc = "Bit 8 - Enable BORH and Step Down counverter forced in Bypass interrups for CPU1"]
    #[inline]
    pub fn eborhsdfb(&mut self) -> _EBORHSDFBW {
        _EBORHSDFBW { w: self }
    }
    #[doc = "Bit 4 - Enable Wakeup pin WKUP5"]
    #[inline]
